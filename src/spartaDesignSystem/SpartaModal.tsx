  ...
  return (
    ...
    >
      <div
        ...
        className={`bg-gray-800 p-10 w-fit max-w-[1250px]  mx-4 transform transition-all duration-300 ease-in-out animate-modalSlideIn rounded-[20px] border-[1px] border-solid ${getStyledType()}`}
