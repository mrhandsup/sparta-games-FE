  ...
  return (
    <div className="font-DungGeunMo text-white leading-5">
      ...
      <p>
        ...
        귀하의 정보를 처리하는 방식을 이해하려면 이 정책을 주의 깊게 읽어주세요. 당사의 정책 및 관행에 동의하지 않는
        경우 이 서비스를 다운로드, 등록 또는 사용하지 마십시오. 이 서비스를 등록 또는 사용함으로써 귀하는 이 개인정보
        보호정책에 동의하게 됩니다.
      </p>
      ...
      <ul className="ms-4 list-disc list-inside space-y-1">
        ...
        <li>서비스 이용 과정에서 작성하는 게시물 (UGC)</li>
      ...
      <ul className="ms-4 list-disc list-inside space-y-1">
        ...
        <li>모바일 기기 정보 (디바이스 ID, 운영체제 버전)</li>
      </ul>
